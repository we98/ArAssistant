...
public class PopupInOperationListActivity extends PopupWindow {

    private Context context;

    public PopupInOperationListActivity(Context context) {
        super(context);
    ...
    private void initalize(){
        ...
        View view = inflater.inflate(R.layout.popupwindow_activity_operationlist, null);
        setContentView(view);
